...
// GPT 5.5 over Codex OAuth — synthesized from the gpt-5.4 codex template
// chain. Context window reflects gpt-5.5's actual 1M support; cost is a
// placeholder mirroring gpt-5.4 until OpenAI publishes official 5.5 numbers.
const OPENAI_CODEX_GPT_55_MODEL_ID = "gpt-5.5";
const OPENAI_CODEX_GPT_55_CONTEXT_TOKENS = 1_000_000;
